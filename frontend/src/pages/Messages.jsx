...
export default function Messages() {
  ...
  return (
    <div className="flex-1 w-full relative flex flex-col pt-6 overflow-hidden">
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 relative z-10 flex flex-col w-full h-[calc(100vh-120px)] overflow-hidden">

        {/* Main Grid Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8 h-full">

          {/* ================= LEFT PANEL (Chats list / Profile Preview) ================= */}
          <div className="hidden lg:flex bg-white rounded-3xl shadow-sm border border-gray-100 flex-col overflow-hidden h-full">
