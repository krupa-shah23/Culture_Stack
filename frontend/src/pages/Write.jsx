    ...
    <div className="flex-1 w-full pb-12 relative flex flex-col pt-6 md:pt-10">
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 relative z-10 flex flex-col md:flex-row gap-8 h-[calc(100vh-120px)] overflow-hidden">
        ...
        <div className="flex-[3] flex flex-col gap-8 overflow-y-auto no-scrollbar pb-12 pr-2">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-[1] flex flex-col gap-4 justify-between">
                ...
                <div className="w-full h-full flex flex-col">
                  ...
                  {mediaPreview ? (
                    <div className="relative w-full h-full min-h-[100px] bg-black/5 rounded-2xl border border-black/10 flex items-center justify-center overflow-hidden">
                      {mediaFile?.type.startsWith("video") ? (
                        <video src={mediaPreview} controls className="max-h-full object-contain" />
                      ) : (
                      ...
                      <button
                        ...
                        className="absolute -top-1 -right-1 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs shadow-md hover:scale-110 transition cursor-pointer z-10"
                      >
                        ×
                      </button>
                    </div>
          ...
          {/* Buttons Rendered Beside Editor */}

          {error && (
            <div className="mt-2 p-4 bg-red-500/20 border border-red-500/50 rounded-xl text-red-300 text-sm text-center">
              {error}
            </div>
          )}
        ...
        {/* ================= RIGHT SIDEBAR ================= */}
        <div className="flex-[1] space-y-8 pl-0">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 p-5 md:p-6 relative overflow-hidden group w-full border-l-4 border-l-[#8C7851]">
            <h3 className="text-lg font-bold mb-3 text-[#1A1A1A]">Writing Tips</h3>
            <p className="text-sm text-charcoal/80 leading-relaxed">
              Clear reflections help teams grow. Focus on describing the situation, how it impacted you, and what could improve.
            </p>
          </div>

          {/* AI Advisor Guide */}
          <div className="bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 p-5 md:p-6 relative overflow-hidden group w-full border-l-4 border-l-[#8C7851]">
            <h3 className="text-lg font-bold mb-3 text-[#1A1A1A]">How AI Advisors Help</h3>
            <p className="text-sm text-charcoal/80 leading-relaxed">
              AI Advisors analyze your reflection and provide strategic, risk-aware, and innovation-focused feedback.
            </p>
          </div>

          {/* Safety Levels Guide */}
          <div className="bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 p-5 md:p-6 relative overflow-hidden group w-full border-l-4 border-l-[#8C7851]">
            <h3 className="text-lg font-bold mb-4 text-[#1A1A1A]">Safety Levels</h3>

            <ul className="space-y-4">
              <li>
                <div className="flex items-center gap-2 mb-1">
                  <span className="w-5 h-5 rounded-full bg-earth-surface text-[#1A1A1A] text-xs font-bold flex items-center justify-center">1</span>
                  <span className="font-semibold text-charcoal">Public</span>
                </div>
                <p className="text-xs text-charcoal/70 pl-7">Visible to everyone in the culture stack feed.</p>
              </li>
              <li>
                <div className="flex items-center gap-2 mb-1">
                  <span className="w-5 h-5 rounded-full bg-earth-surface text-[#1A1A1A] text-xs font-bold flex items-center justify-center">2</span>
                  <span className="font-semibold text-charcoal">Team</span>
                </div>
                <p className="text-xs text-charcoal/70 pl-7">Only visible to members of your verified team.</p>
              </li>
              <li>
                <div className="flex items-center gap-2 mb-1">
                  <span className="w-5 h-5 rounded-full bg-earth-surface text-[#1A1A1A] text-xs font-bold flex items-center justify-center">3</span>
                  <span className="font-semibold text-charcoal">Anonymous</span>
                </div>
                <p className="text-xs text-charcoal/70 pl-7">Identity hidden. Perfect for open, psychological safety.</p>
              </li>
            </ul>
          </div>
